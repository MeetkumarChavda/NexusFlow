...
return (
    ...
    <h1 className="my-6 text-2x1">My reservations</h1>
        <div className="space-y-4">
            <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded xl">
                ...
                <div className="col-span-1 md:col-span-3">
                    ...
                    <div className="mt-6 inline-block cursor-pointer py-4 px-6 bg-nexus text-white rounded-xl">Go to Property</div>
                </div>
            </div>
