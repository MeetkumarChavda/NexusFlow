    ...
    const content = (
        <>
            {currentStep === 1 ? (
                ...
                <>
                    <h2 className='mb-6 text-2xl'>Describle your place</h2>
                ...
                <>
                    ...
                    <div className="pt-3 pb-6 space-y-4">
                        ...
                        {dataImage && (
                            <div className='w-[200] h-[150px] relative'>
                                <Image
                                    fill
                                    alt='Uploaded image'
                        ...
                        {errors.map((error,index) =>{
                            return (
                                <div 
                                    key={index} 
                                    className='p-5 mb-4 bg-nexus text-white rounded-xl opacity-80'
                                >
                                    {error}
                                </div>
                            )
